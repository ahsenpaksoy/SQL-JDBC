...
public class PreparedStatement01 {
    public static void main(String[] args) throws SQLException {
        ...
        //String sql = "UPDATE companies SET number_of_employees = 9999 WHERE company='IBM'";  burdakileri parametrelendiricez
        ...
        int guncellenenSatirSayisi = preparedStatement.executeUpdate();  //Bir satir guncelledi
...
//Update yapılınca executeUpdate(),
//Create yapacaksak execute(),
//Verinin kendisini görmek istiyorsak executeQuery() methodu kullanıyoruz..
