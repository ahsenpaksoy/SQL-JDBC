...
-- sehir ve tel sutununun data turu uyumlu olmali.tel char yani string bir data turu,
-- sehir de varchar o da string o yuzden problem yok. maas ve cocuk_sayisi da uyumlu olmali
...
--ilike buyuk harf kucuk harf gozetmeksizin ...gibi anlamina gelir
-- NOT : buyuk harf kucuk harf gozetmeksizin listelemek istersek ilike kullanilir.
