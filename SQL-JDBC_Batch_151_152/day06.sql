...
/*
 ...
 where komutundan farki : Gruplama yaptiktan sonra, cikan sonucta 
 sart kosulacaksa having komutu kullanilir.
 
 where gruplama yapmadan once
having gruplama yaptiktan sonra

*/

--SORU08: ulke'lere göre yas ortalamasını bulup, yas ortalaması 33'den buyuk olanları listeleyiniz. 

select ulke, round(avg(yas)) as ort_yas from insan group by ulke having avg(yas)>33;
