...
--fetch next 2 row only komutu da limit ile ayni isi yapar
...
select isyeri, isim, maas from calisanlar where isyeri in ('Pierre Cardin','LCWaikiki')

--cevabi dinamik yapalim
...
--2. yol
select kitap_isim, yazar_isim from yazarlar as A right join kitaplar as B 
on B.kitap_id=A.kitap_id;

--tablolara da gecici isim verebiliriz
